...
function showNewsinfoAndComments()
{
    ...
    var funct = function ()
    {
        if (xhttp.readyState==4 && xhttp.status==200)
        {
            ...
            document.getElementById("newsdetailsimagelink").href = "/Socion/Story/ReadArticle?aid=" + articleid;
           ...
           if(trim(News_description) == "")
            ...
            html = html + "<tr style=\"font-size:15px;height:10px\" align=\"center\">" + "<td colspan=\"7\"> <b> <a href=\"" + "/Socion/Story/ReadArticle?aid=" + articleid  + "\"target=\"_blank\" class=\"link\">" + News_title + "</a>" + "</td></tr>" + 
...
function showComments()
{
    ...
    var url = "/Socion/resources/comments/" + articleid;
...
function postComment()
{
    ...
    var url =  "/Socion/resources/comments/" ;
    var xhttp = getXMLHttpRequestObject();
...
function deleteComment(clicked_row)
{
    ...
    var url =  "/Socion/resources/comments/" + "?commentId=" + commentId;
    var xhttp = getXMLHttpRequestObject();
