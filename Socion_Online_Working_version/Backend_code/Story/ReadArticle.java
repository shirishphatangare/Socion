...
public class ReadArticle extends HttpServlet 
{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            out.println("FB.init({appId : '273812109363920',status: true,cookie: true,xfbml: true, oauth: true });");
            ...
            out.println("document.location  = \"https://www.facebook.com/dialog/oauth/?client_id=273812109363920&redirect_uri=http://www.oursocion.com/Socion/Story/ReadArticle?aid=\" + articleId + \"&scope=email,publish_actions\" ");
