...
function DisplayfreshInbox(pageNumber)
{
    var Loggeduser = getCookie('Loggeduser');
    
    document.getElementById("newslist").innerHTML = "";
    document.getElementById("newsbanner").innerHTML = "<img src=\"../images/wait.gif\" alt=\"\">" ;

    var url = "/Socion/resources/articles/inbox" + "?page=" + pageNumber;
    ...
    var funct1 = function ()
    {
        if ((xhttp1.readyState==4) && (xhttp1.status == 200))
        {
            ...
            document.getElementById("newsbanner").innerHTML = "Inbox";
            document.getElementById("changeInboxSettingsLink").href = "Change_Config.html?td=" +  tokenID;
            document.getElementById("newslist").innerHTML = html;
            
            displayInboxPagination(pageCount,pageNumber);
