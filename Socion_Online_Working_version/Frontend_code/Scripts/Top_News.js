        ...
        if ((xhttp1.readyState==4) && (xhttp1.status == 200))
        {
            ...
            if(readarticleID.length > 0)
            {
                ...
                for (var i=0; i < readarticleID.length; i++)
                {
                    ...
                    News_Image_Url_Str +
                    "<td style=\"font-size:10px;\" nowrap=\"nowrap\">" + News_Avg_Rating + "</td>" +
            ...
            document.getElementById("newslist").innerHTML = html;
                ...
                displayFavouriteArticlesPagination(pageCount,pageNumber);
            
            document.getElementById("newsCount").innerHTML= "";
            
            getratingsList();
            
            for(var index=0; index<readarticleID.length; index++)
            {
