...
function getarticlesIndexList(fullname, username, pageNumber)
{
    ...
    var url = "/resources/articles/member/" + username + "?page=" + pageNumber;
    ...
    var funct1 = function ()
    {
        if (xhttp1.readyState==4 && xhttp1.status==200)
        {
                ...
                if(readarticleID.length > 0)
                {
                    ...
                    for (var i=0; i < readarticleID.length; i++)
                    {
                        ...
                        if(trim(News_Image_Url) == "")
                            News_Image_Url_Str = "<td width=\"60px\">" + "<a href=\"" + "/Story/ReadIndexArticle?aid=" + News_article_id  +  "\" class=\"link\" target=\"_blank\">" + "<img src=\"../images/no_image.jpg\" width=\"50\" height=\"50\" align=\"center\" border=\"0\" onmouseover=\"this.style.border='medium solid #0000FF';\" onmouseout=\"this.style.border='none'\">  </a></td>";
                        else
                            News_Image_Url_Str = "<td width=\"60px\">" + "<a href=\"" + "/Story/ReadIndexArticle?aid=" + News_article_id  +  "\" class=\"link\" target=\"_blank\">" + "<img src=\"" + News_Image_Url + "\" width=\"50\" height=\"50\" align=\"center\" border=\"0\" onmouseover=\"this.style.border='medium solid #0000FF';\" onmouseout=\"this.style.border='none'\">  </a></td>";
                        ...
                        "<td style=\"font-size:12px;\" align=\"left\"> <b> <a href=\"" + "/Story/ReadIndexArticle?aid=" + News_article_id  +  "\" class=\"link\"  target=\"_blank\" >" + News_title + "</a>" + "</b><br/>" + "<font size=\"1\" color=\"green\">" + News_url.substring(0,100) + "<br/></font>" + News_description_Str +
                ...
                document.getElementById("indexnewsbanner").innerHTML = "Postbox <small> for " + fullname + "</small> <a id=\"refreshicon\" style=\"cursor:pointer; margin:2px; float: left\" onclick=\"getarticlesIndexList('" + fullname + "', '"+ username +"','1');\" ><img src=\"../images/refresh.jpg\" alt=\"\" height=\"20\" title=\"Refresh\"></a>";    
                ...
                displayIndexPaginationForUser(fullname, username, pageNumber, pageCount);
        }
    };
