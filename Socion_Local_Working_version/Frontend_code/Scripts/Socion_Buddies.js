...
function showFollowersTo()
{
    ...
    var url = "/resources/members/friends/from";
...
function showFollowedBy()
{
    ...
    var funct1 = function ()
    {
        if ((xhttp1.readyState==4) && (xhttp1.status == 200))
        {
            ...
            url = "/resources/members/friends/to";
            var xhttp = getXMLHttpRequestObject();
...
function searchFriends(Query)
{
    ...
    var funct = function ()
    {
        if ((xhttp.readyState==4) && (xhttp.status == 200))
        {
            ...
            url = "/resources/members/search" + "?query=" + searchQuery;
            var xhttp1 = getXMLHttpRequestObject();
...
function addAsBuddy(j)
{
    ...
    var url = "/resources/trusts/" + fromto + "?trustScore=" + trustScore;
    var xhttp = getXMLHttpRequestObject();
