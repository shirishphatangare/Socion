...
function searchIndexNews(pageNumber)
{
    ...
    var url = "/resources/articles/search" + "?query=" + searchQuery + "&page=" + pageNumber;
    var xhttp1 = getXMLHttpRequestObject();
...
{
    var url = "/resources/members/membername/" + Loggeduser;
    var xhttp = getXMLHttpRequestObject();
...
function SetconfigPage()
{
    ...
    var url = "/resources/members/" + Loggeduser;
    var xhttp = getXMLHttpRequestObject();
...
function updateOutboxforLoggeduser(articleID)
{
    ...
    var xhttp = getXMLHttpRequestObject();
    var url = "/resources/outbox/" + Loggeduser + "?ds=OutboxInbox" ;
...
function getUserOutbox()
{
    ...
    var url = "/resources/outbox/" + Loggeduser;
...
function checkPageValidity()
{
    ...
    else
    {
        if(tokenID != "")
        {
            var url = "/resources/token/pageValidity?td=" + tokenID;
            var xhttp = getXMLHttpRequestObject();
